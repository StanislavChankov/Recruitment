...
namespace Synergy.Recruitment.Business.Factories
{
    ...
    public static class MockFactory
    {
        ...
        public static IEnumerable<Candidate> GetCandidates()
            => new List<Candidate>
            {
                new Candidate { Id = 1, FirstName = "Marcia", LastName = "Cantu", PositionId = 1, UpdatedOn = DateTime.Now.AddDays(-1) },
                new Candidate { Id = 2, FirstName = "Ryder", LastName = "Nicholson", PositionId = 2, UpdatedOn = DateTime.Now.AddDays(-2) },
                new Candidate { Id = 3, FirstName = "Eloisa", LastName = "Wise", PositionId = 3, UpdatedOn = DateTime.Now.AddDays(-3) },
                new Candidate { Id = 4, FirstName = "Johnathon", LastName = "Fountain", PositionId = 4, UpdatedOn = DateTime.Now.AddDays(-4) },
                new Candidate { Id = 5, FirstName = "Lyra", LastName = "Thomas", PositionId = 5, UpdatedOn = DateTime.Now.AddDays(-5) },
                new Candidate { Id = 6, FirstName = "Lacy", LastName = "Reilly", PositionId = 6, UpdatedOn = DateTime.Now.AddDays(-6) },
                new Candidate { Id = 7, FirstName = "Tiya", LastName = "Atkins", PositionId = 7, UpdatedOn = DateTime.Now.AddDays(-7) },
                new Candidate { Id = 8, FirstName = "Harris", LastName = "Weir", PositionId = 8, UpdatedOn = DateTime.Now.AddDays(-8) },
                new Candidate { Id = 9, FirstName = "Cassia", LastName = "Livingston", PositionId = 9, UpdatedOn = DateTime.Now.AddDays(-9) },
                new Candidate { Id = 10, FirstName = "Tehya", LastName = "Brooks", PositionId = 10, UpdatedOn = DateTime.Now.AddDays(-10) },
                new Candidate { Id = 11, FirstName = "Herbie", LastName = "Major", PositionId = 11, UpdatedOn = DateTime.Now.AddDays(-11) },
