...
namespace Synergy.Recruitment.Business.Factories
{
    ...
    public static class MockFactory
    {
        ...
        public static IEnumerable<Candidate> GetCandidates()
            => new List<Candidate>
            {
                new Candidate { Id = 1, UpdatedOn = DateTime.Now.AddDays(-1) },
                new Candidate { Id = 2, UpdatedOn = DateTime.Now.AddDays(-2) },
                new Candidate { Id = 3, UpdatedOn = DateTime.Now.AddDays(-3) },
                new Candidate { Id = 4, UpdatedOn = DateTime.Now.AddDays(-4) },
                new Candidate { Id = 5, UpdatedOn = DateTime.Now.AddDays(-5) },
                new Candidate { Id = 6, UpdatedOn = DateTime.Now.AddDays(-6) },
                new Candidate { Id = 7, UpdatedOn = DateTime.Now.AddDays(-7) },
                new Candidate { Id = 8, UpdatedOn = DateTime.Now.AddDays(-8) },
                new Candidate { Id = 9, UpdatedOn = DateTime.Now.AddDays(-9) },
                new Candidate { Id = 10, UpdatedOn = DateTime.Now.AddDays(-10) },
                new Candidate { Id = 11, UpdatedOn = DateTime.Now.AddDays(-11) },
                new Candidate { Id = 12, UpdatedOn = DateTime.Now.AddDays(-12) },
                new Candidate { Id = 13, UpdatedOn = DateTime.Now.AddDays(-13) },
                new Candidate { Id = 14, UpdatedOn = DateTime.Now.AddDays(-14) },
                new Candidate { Id = 15, UpdatedOn = DateTime.Now.AddDays(-15) },
                new Candidate { Id = 16U, UpdatedOn = DateTime.Now.AddDays(-16) },
                new Candidate { Id = 17, UpdatedOn = DateTime.Now.AddDays(-17) },
            };
    }
}
